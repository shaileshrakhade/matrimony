package com.matrimony.admin.securityConfig;


import com.matrimony.admin.securityConfig.authenticationFilter.CusomeAuthenticationFilter;
import com.matrimony.admin.securityConfig.enums.Role;
import com.matrimony.admin.securityConfig.service.CustomUserDetailsService;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                .authorizeHttpRequests(auth ->
                        auth.requestMatchers("/master-attribute/admin/**").hasAuthority(Role.ADMIN.toString())
