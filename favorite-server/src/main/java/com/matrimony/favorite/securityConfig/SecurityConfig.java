package com.matrimony.favorite.securityConfig;


import com.matrimony.favorite.securityConfig.authenticationFilter.CusomeAuthenticationFilter;
import com.matrimony.favorite.securityConfig.enums.Role;
import com.matrimony.favorite.securityConfig.service.CustomUserDetailsService;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                .authorizeHttpRequests(auth ->
                        auth.requestMatchers("/favorite/admin/**").hasAuthority(Role.ADMIN.toString())
