...
public class OAuth2UserService {
    ...
    public void createUserOAuthPostLogin(DefaultOidcUser defaultOidcUser) throws SQLException {
...
//                            .address(mapToAdress(defaultOidcUser.getAddress()))
        ...
        oAuth2UserRepository.save(oAuth2Users);
    }

    private Address mapToAdress(AddressStandardClaim address) {
